...
# Example 1
print("Example 1 : reuse standard exception")
try:
...
# Example 2
# my_module.py
print("\nExample 2-3 : define api root exception, catch root exception")
...
# Example 4
print("\nExample 4 : catch individual and api-root exception")
weight = 5
try:
    weight = my_module.determine_weight(1, -1)
    assert False
...
# Example 5
print("\nExample 5 : catch individual, api-root and stadard-root exception")
weight = 5
try:
    weight = my_module.determine_weight(1, -1)
    assert False
...
# Example 6
print("\nExample 6-7 : add detailed exception later")
# my_module.py
