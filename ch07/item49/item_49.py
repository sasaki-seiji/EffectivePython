...
# Example 1
print("Example 1 : function doc - palindrome")
def palindrome(word):
    """Return True if the given word is a palindrome."""
    return word == word[::-1]

assert palindrome('tacocat')
print("palindrome('tacocat'):", palindrome('tacocat'))
assert not palindrome('banana')
print("palindrome('banana'):", palindrome('banana'))
...
# 2016.07.05 add
print("\nExample 4 : class doc - Player")
print(repr(Player.__doc__))


# Example 5
print("\nExample 5 : fucntion doc - find_anagrams")
import itertools
...
print("find_anagrams('pancakes', ['scanpeak']):", find_anagrams('pancakes', ['scanpeak']))