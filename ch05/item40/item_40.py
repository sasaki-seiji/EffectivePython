...
# Example 1
print("Example 1 : introduce coroutine")
def my_coroutine():
    while True:
        received = yield
...
# Example 2
print("\nExample 2-3 : minimize coroutine")
def minimize():
    current = yield
    while True:
        value = yield current
...
# Example 4
print("\nExampl 4-7 : count_neighbars coroutine")
ALIVE = '*'
EMPTY = '-'
...
# Example 8
print("\nExample 8 - 11 : step_cell coroutine")
Transition = namedtuple('Transition', ('y', 'x', 'state'))


# Example 9
# 2016.07.01 delete : duplicate function
...
# Example 16
print("\nExample 16 : initial state of grid")
grid = Grid(5, 9)
...
print("\nExample 20 : introductory diagram")
grid = Grid(5, 5)
